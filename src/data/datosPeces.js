...
export const PECES_COLOMBIANOS = {
  ...
  bagre_rayado: {
    ...
    imagen: '/assets/imagenes/peces/Bagre_rayado.png',
    imagenAlternativa: '/assets/imagenes/peces/Bagre_rayado.png',
    rareza: 'raro',
    dificultad: 6,
    pesoMin: 5.0,
    pesoMax: 25.0,
  ...
  sabalo: {
    ...
    imagenAlternativa: '/assets/imagenes/peces/Sabalo.png',
    rareza: 'común',
    dificultad: 4,
    pesoMin: 1.0,
    pesoMax: 8.0,
  ...
  pavon: {
    ...
    imagen: '/assets/imagenes/peces/Pavon.png',
    imagenAlternativa: '/assets/imagenes/peces/Pavon.png',
    rareza: 'épico',
    dificultad: 8,
    pesoMin: 3.0,
    pesoMax: 15.0,
